...
const GlobalStyle = createGlobalStyle`
 @keyframes bgAnimation {
  ...
  100% {
    background-color: rgba(8,100,85,0.8); 
    color: aliceblue !important;
  }
}
`;
...
const AlerContainer = styled.div`
  ...
  left: 36%;
`;
const shops = ["Korkmaz", "Karaca", "A101", "Armağan", "toyzz shop"];

const categories = ["Ev", "Oyuncak", "Ev"];
...
function App() {
  ...
  return (
    <> 
      <GlobalStyle />
      <h1 className="text-center" style={{textAlign: "center", margin: "0 auto", padding: "20px"}}>Shopping List</h1>
      <Container
